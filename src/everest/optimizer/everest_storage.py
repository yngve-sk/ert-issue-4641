...
@dataclasses.dataclass
class EverestStorageROPTObserver:
    enopt_storage: "EverestStorage"
...
class EverestStorage:
    ...
    def create_ropt_observer(self) -> EverestStorageROPTObserver:
        return EverestStorageROPTObserver(enopt_storage=self)
